...
def attack(char_name: str, char_class: Optional[str]) -> Optional[str]:
...
def defence(char_name: str, char_class: Optional[str]) -> Optional[str]:
    if char_class == 'warrior':
...
def special(char_name: str, char_class: Optional[str]) -> Optional[str]:
    if char_class == 'warrior':
